...
export const SchoolsTimetables = () => {
    ...
    const navigateCreateTimetablesPage = () => {
        navigate(`/schools_owner/schools/${schoolId}/timetables/new`)
    }
    ...
    return (
        <>
            ...
            {loading ? (<Loader/>) : (
                <>
                    <Button variant={'blue'} type={'button'} onClick={() => navigateCreateTimetablesPage()}>Создать
                        расписание</Button>
                    <Table>
                        <TableRow head>
                        ...
                        {
                            schoolOwnerTimetables && schoolOwnerTimetables.length > 0 ? schoolOwnerTimetables.map(timetable => (
