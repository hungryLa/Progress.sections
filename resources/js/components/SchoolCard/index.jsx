...
export const SchoolCard = ({id, title, types, description, image}) => {
    ...
    return (
        <Link className={'school-card'} to={`/schools_owner/schools/${id}`}>
            <div className={'school-card__inner'}>
                <img className={'school-card__image'} src={image.length > 0 ? `/storage/${image[0]?.path}` : 'https://placehold.co/600x400'} alt={title}/>
