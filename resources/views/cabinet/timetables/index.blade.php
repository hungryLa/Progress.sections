...
@section('content')
    <div class="row">
        ...
        <div class="col-9">
            ...
            <a class="btn btn-success" href="{{route('timetables.create',compact('teacher'))}}">{{__('other.Add a record')}}</a>
                ...
                <table class="table">
                    ...
                    @foreach($timetables as $timetable)
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-warning" href="{{route('timetables.edit',compact('teacher','timetable'))}}">{{__('other.Change')}}</a>
                            </td>
                            <td>
                                <form method="POST" action="{{route('timetables.delete',compact('teacher','timetable'))}}">
                                    @csrf
                                    @method('DELETE')
